      ...
      // ─────────────────────────────────────────────────────────────
      {
        ...
        fields: [
          ...
          { type: "string", name: "mapUrl", label: "Google Maps link" },
          {
            ...
            label: "Office hours",
            list: true,
            ui: { itemProps: (i) => ({ label: `${i?.day ?? "Day"} \u2014 ${i?.hours ?? ""}` }) },
            fields: [
          ...
          },
          {
            ...
            list: true,
            ui: { itemProps: (i) => ({ label: `${i?.time ?? ""} \u2014 ${i?.label ?? "Item"}` }) },
            fields: [
      ...
      // ─────────────────────────────────────────────────────────────
      {
        ...
        fields: [
          ...
          },
          {
            ...
            label: "Sections",
            list: true,
            ui: { itemProps: (i) => ({ label: i?.heading || "Section" }) },
            fields: [
              ...
              { type: "string", name: "note", label: "Small note at the end" },
              {
                type: "object",
                name: "items",
                label: "List of items in this section",
                list: true,
