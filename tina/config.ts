...
export default defineConfig({
  ...
  ...((process.env.TINA_SEARCH_TOKEN || "").trim()
    ? { search: { tina: { indexerToken: (process.env.TINA_SEARCH_TOKEN || "").trim(), stopwordLanguages: ["eng"] } } }
    : {}),
    ...
    collections: [
      ...
      // ─────────────────────────────────────────────────────────────
      {
        ...
        fields: [
          ...
          { type: "string", name: "churchCenterUrl", label: "Church Center address",
